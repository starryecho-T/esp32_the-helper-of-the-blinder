...
$newAia  = 'd:\projects\cane_controller_camera_detect.aia'
if (Test-Path $newAia) { Remove-Item $newAia }
$base = 'src/appinventor/ai_zjj44450/cane_controller_2__v2hfg/'
$bkyEntry = $base + 'Screen1.bky'
$scmEntry = $base + 'Screen1.scm'
$dir = 'd:\projects\aia_extracted\' + $base
$bkyBytes = $utf8NoBom.GetBytes([System.IO.File]::ReadAllText($dir + 'Screen1.bky', [System.Text.Encoding]::UTF8))
$scmBytes = $utf8NoBom.GetBytes([System.IO.File]::ReadAllText($dir + 'Screen1.scm', [System.Text.Encoding]::UTF8))
